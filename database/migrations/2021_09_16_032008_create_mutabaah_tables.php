...
class CreateMutabaahTables extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mutabaah_tables', function (Blueprint $table) {
            $table->id();
            $table->date('tanggal');
            $table->string('nama');
            ...
            $table->integer('juz_terakhir_yang_dibaca');
    ...
    {
        Schema::dropIfExists('mutabaah_tables');
    }
}
